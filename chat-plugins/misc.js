...
let messages = [
	...
	"felt Dyna's premenstrual wrath.",
	"spoke of the Wonder Guard Sableye incident.",
	"exploded.",
	"got scared by the crazy ass admins and left.",
	"killed them. {{user}} killed them all.",
	"got choice locked!",
	"insulted Suicune!",
	"felt Hope's wrath.",
	"accidentally got Dyna talking about Terraria.",
	"criticised Tokyo Ghoul.",
	"criticised Lancer in front of Dyna.",
	"was forced to drive a spear through their chest.",
	"broke.",
	"discovered the real world.",
	"was deported.",
	"got Trump'd.",
	"{{user}}'s mom accidently kicked {{user}} from the server!",
];
